...
workloader svc-import Instruqt-Vensim-Lab/svcs.csv --update-pce --provision --no-prompt && workloader svc-import Instruqt-Vensim-Lab/svcs-meta.csv --meta --update-pce --no-prompt --provision
